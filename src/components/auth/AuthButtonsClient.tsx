    ...
    <div className="auth-buttons flex items-center gap-2">
      {isLoggedIn ? (
        ...
        <a
          href={loginHref}
          onClick={handleLogin}
          className="inline-flex items-center justify-center gap-1.5 rounded-md text-sm transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-600 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none bg-primary-600 hover:bg-primary-700 text-white h-8 px-4"
        >
